    ...
    <q-form @submit.prevent="submit" ref="postForm">
      <div class="justify-center items-center content-center q-px-md col-12">
        ...
        <div class="column col-xs-12 q-pt-md justify-start">
          <div class="text-subtitle1 q-pb-sm text-primary">Merci d'entrer le mot de passe que vous avez renseignez lors de la publication de l'annonce.</div>
        </div>
        ...
        <div class="row justify-center items-center content-center col-xs-12 q-mt-md">
          <q-btn :loading="submitting" color="input" type="submit" rounded class="bg-button" label="Supprimer" />
