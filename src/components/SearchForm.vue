<template>
  <div class="col-12">
    <div
      class="row justify-center items-center content-center q-pa-md col-12"
      @click="dialog = true"
    >
      <div class="col-xs-12">
    ...
    >
      <q-card class="bg-primary text-white">
        ...
        <div
          class="bg-primary text-white row justify-center items-center content-center q-px-md col-12"
        >
          <q-form @submit.prevent="search" ref="searchForm">
            ...
            <div
              class="row justify-center items-center content-center q-pb-xl col-xs-12 col-sm-6 col-md-4 q-pl-md-md col-lg-3"
            >
  ...
  methods: {
    ...
    async search() {
      if (this.$refs.searchForm.validate()) {
        ...
        store.dispatch('CommonStore/setProfil', this.formProfil)
        store.dispatch('CommonStore/setCriteria', this.formCriteria)
        await store.dispatch('CommonStore/search')
